...
class Constants(db.Model):
    ...
    p1_linearity: Mapped[float] = mapped_column(db.Float)
    p1_hysteresis: Mapped[float] = mapped_column(db.Float)
    p2_slope: Mapped[float] = mapped_column(db.Float)
    p2_offset: Mapped[float] = mapped_column(db.Float)
    p2_linearity: Mapped[float] = mapped_column(db.Float)
    p2_hysteresis: Mapped[float] = mapped_column(db.Float)
    x_slope: Mapped[float] = mapped_column(db.Float)
    x_offset: Mapped[float] = mapped_column(db.Float)
    x_linearity: Mapped[float] = mapped_column(db.Float)
    x_hysteresis: Mapped[float] = mapped_column(db.Float)
...
class Test(db.Model):
    ...
    air_pressure: Mapped[float] = mapped_column(db.Float)
    scan_rate_actual: Mapped[float] = mapped_column(db.Float)
